...
public class CalendarioServlet extends HttpServlet {
	...
	public void riempiCalendario (int mese, int anno, int[] days_month) {
		...
		case "MONDAY": day = 0; break; //luned�
		case "TUESDAY": day = 1; break; //marted�
		case "WEDNESDAY": day = 2; break; //mercoled�
		case "THURSDAY": day = 3; break; //gioved�
		case "FRIDAY": day = 4; break; //venerd�
