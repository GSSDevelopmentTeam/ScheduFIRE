...
<div class="rw" style="margin:50px;">
  ...
  <form action="GestioneFerieServlet" method="POST">
   	<button class="btop"><img src="Icon/solecolore.png">  <span class="rht">Gestione<br> Ferie</span></button>
  </form></div>
   	<div class="clm">
   	<form action="GestionePersonaleServlet" method="POST">
	<button class="btop"><img src="Icon/ominoVF.png"	>  <span class="rht">Gestione<br> Personale</span></button>
	</form></div>
	 <div class="clm">
